...
namespace MovApp.Controllers
{
    public class CreatorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CreatorId,Name,Surname,Birthday")] Creator creator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CreatorId,Name,Surname,Birthday")] Creator creator)
        {
            if (ModelState.IsValid)
            {
